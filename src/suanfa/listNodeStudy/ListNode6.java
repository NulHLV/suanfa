...
public class ListNode6 {
    public static void main(String[] args) {
        ...
        ListNode result = sortList_test1(node1);
...
//        mid.next = null后，left变成了A->B->C，right是 D->E
    ...
    public static ListNode sortList_test1(ListNode head) {
        if (head == null || head.next == null) {
            return head;
        }

        // 找中位
        ListNode mid = getMidNode_test1(head);
        ...
        // 排序
        left = sortList_test1(left);
        right = sortList_test1(right);

        // 合并
        return merge_test1(left, right);

    }

    public static ListNode getMidNode_test1(ListNode head) {
        ListNode fast = head.next;
        ListNode slow = head;
    ...
    public static ListNode merge_test1(ListNode left, ListNode right) {
